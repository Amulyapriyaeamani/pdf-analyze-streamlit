...
st.set_page_config(page_title="PDF Analyzer",page_icon=':page_facing_up:')
...
def main():
    ...
    <div style="
        ...
        text-align: center;
    ">
        <p>Made by <a href='https://x.com/amulyaeamani'>The Tech Wizzes</a></p>
    </div>
    """
    ...
    st.sidebar.image("img/PdfBot1.png")
